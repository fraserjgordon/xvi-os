macro_rules! int_type_common_members
{
    ...
    (
        ...
        */
        ...
        {
            $crate::intrinsics::wrapping_mul(self, rhs)
        }
        /*
        #[must_use]
...
macro_rules! int_type
{
    ...
    (
        ...
        impl $t
        {
            int_type_common_members!{$t, $bits, $unsigned, $name}
        }
    )
}
...
{
    ($T:ty, $Bits:expr) => (uint_type!{$T, $Bits, stringify!{$T}});
    ...
    (
        ...
        impl $t
        {
            int_type_common_members!{$t, $bits, $t, $name}
