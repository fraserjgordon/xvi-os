#include <System/CRT/Atomic/Atomic.h>

#include <System/CRT/Atomic/AtomicSpinlock.hh>
...
__bool __Atomic_is_lock_free(__size_t size, const volatile void* ptr)
{
...
__bool __Atomic_test_and_set(volatile void* ptr)
{
    return __Atomic_test_and_set_explicit(ptr, __memory_order_seq_cst);
}

__bool __Atomic_test_and_set_explicit(volatile void* ptr, int)
{
#if __CRT_ASSUME_ARMV6
...
__bool __Atomic_test_and_set_1(volatile void* ptr, int order)
{
#if __CRT_ASSUME_ARMV6K
...
__bool __Atomic_test_and_set_2(volatile void* ptr, int order)
{
    // Just use the byte implementation.
    return __Atomic_test_and_set_1(ptr, order);
}

__bool __Atomic_test_and_set_4(volatile void* ptr, int order)
{
#if __CRT_ASSUME_ARMV6
...
__bool __Atomic_test_and_set_8(volatile void* ptr, int order)
{
    return __Atomic_test_and_set_4(ptr, order);
}

__bool __Atomic_test_and_set_16(volatile void* ptr, int order)
{
    return __Atomic_test_and_set_4(ptr, order);
}
...
__bool __Atomic_compare_exchange_##n(volatile void* ptr, void* expect, type desired, int, int) \
{ \
...
__bool __Atomic_compare_exchange_##n(volatile void* ptr, void* expect, type desire, int, int) \
{ \
    __uintptr_t aligned_ptr = __uintptr_t(ptr) & ~(sizeof(__uint32_t) - 1); \
    __size_t shift = __uintptr_t(ptr) - aligned_ptr; \
    __uint32_t mask = ~(((1 << (8 * n)) - 1) << shift); \
...
__bool __Atomic_compare_exchange_1(volatile void* ptr, void* expect, __uint8_t desire, int, int)
{
    return __Atomic_compare_exchange(1, ptr, expect, &desire, 0, 0);
}
__bool __Atomic_compare_exchange_2(volatile void* ptr, void* expect, __uint16_t desire, int, int)
{
    return __Atomic_compare_exchange(2, ptr, expect, &desire, 0, 0);
}
__bool __Atomic_compare_exchange_4(volatile void* ptr, void* expect, __uint32_t desire, int, int)
{
...
__bool __Atomic_compare_exchange_8(volatile void* ptr, void* expect, __uint64_t desire, int, int)
{
...
__bool __Atomic_compare_exchange_8(volatile void* ptr, void* expect, __uint64_t desire, int succeed, int fail)
{
...
__bool __Atomic_compare_exchange_16(volatile void* ptr, void* expect, __uint128_t desire, int, int)
{
    auto lock = g_atomicSpinlocks.getLock(ptr);
...
__bool __Atomic_compare_exchange(__size_t n, volatile void* ptr, void* expect, void* desire, int success, int fail)
{
