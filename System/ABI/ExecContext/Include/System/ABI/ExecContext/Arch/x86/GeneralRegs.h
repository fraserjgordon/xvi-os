...
#include <System/ABI/ExecContext/Arch/x86/Eflags.h>
...
struct interrupt_error_code_vector_t :
    interrupt_error_code_t<Vector == 8 || (10 <= Vector && Vector <= 14) || Vector == 17>
{
};
...
struct interrupt32_near_t :
    interrupt_error_code_vector_t<Vector>
{
...
static_assert(sizeof(interrupt32_near_t<8>) == 16);
static_assert(sizeof(interrupt32_near_t<255>) == 12);
...
static_assert(sizeof(interrupt32_far_t<8>) == 24);
static_assert(sizeof(interrupt32_far_t<255>) == 20);
...
static_assert(sizeof(interrupt_v86_t<8>) == 40);
static_assert(sizeof(interrupt_v86_t<255>) == 36);
...
static_assert(sizeof(interrupt64_t<8>) == 48);
static_assert(sizeof(interrupt64_t<255>) == 40);
