...
static inline void xrstor(xsave_flag_t states, const fxsave_t* save_area)
{
    ...
    (
        ...
        :
        : "m" (*save_area),
          "a" (std::uint64_t(states) & 0xFFFFFFFF),
          "d" ((std::uint64_t(states) >> 32) & 0xFFFFFFFF)
        : "memory"
    );
}
...
__SYSTEM_ABI_EXECCONTEXT_EXPORT bool $System$ABI$ExecContext$isXsaveSupported(void);
__SYSTEM_ABI_EXECCONTEXT_EXPORT bool $System$ABI$ExecContext$isXsaveAvailable(void);

__SYSTEM_ABI_EXECCONTEXT_EXPORT uint64_t $System$ABI$ExecContext$xgetbv(uint32_t);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsetbv(uint32_t, uint64_t);

__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xrstor(uint64_t, const void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xrstors(uint64_t, const void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsave(uint64_t, void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsavec(uint64_t, void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsaveopt(uint64_t, void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsaves(uint64_t, void*);

#if defined(__x86_64__)
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xrstor64(uint64_t, const void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xrstors64(uint64_t, const void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsave64(uint64_t, void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsavec64(uint64_t, void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsaveopt64(uint64_t, void*);
__SYSTEM_ABI_EXECCONTEXT_EXPORT void $System$ABI$ExecContext$xsaves64(uint64_t, void*);
#endif
