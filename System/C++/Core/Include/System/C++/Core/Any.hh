#ifndef __SYSTEM_CXX_CORE_ANY_H
#define __SYSTEM_CXX_CORE_ANY_H
...
public:
    ...
    template <class _T>
        requires (!is_same_v<decay_t<_T>, any>)
            && (!__detail::__is_in_place_type_specialization_v<decay<_T>>)
            && is_copy_constructible_v<decay_t<_T>>
    any(_T&& __t)
        : any()
    {
    ...
    template <class _T, class... _Args>
        requires is_copy_constructible_v<decay_t<_T>>
            && is_constructible_v<decay_t<_T>, _Args...>
    ...
    template <class _T, class _U, class... _Args>
        requires is_copy_constructible_v<decay_t<_T>>
            && is_constructible_v<decay_t<_T>, std::initializer_list<_U>&, _Args...>
    explicit any(in_place_type_t<_T>, std::initializer_list<_U> __il, _Args&&... __args)
        : any()
    {
        using _VT = decay_t<_T>;
        __detail::__any_utils<_VT> __utils;
    ...
    template <class _T, class _U, class... _Args>
        requires is_copy_constructible_v<decay_t<_T>>
            && is_constructible_v<decay<_T>, std::initializer_list<_U>&, _Args...>
...
inline void swap(any& __l, any& __r) noexcept
{
    __l.swap(__r);
}
...
#endif /* ifndef __SYSTEM_CXX_CORE_ANY_H */
