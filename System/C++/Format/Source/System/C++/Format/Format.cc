...
/*std::string vformat(const locale& __loc, string_view __fmt, format_args __args)
{
    std::string __out;
    __detail::__contiguous_append_iterator __iter(__out);
...
std::wstring vformat(const locale& __loc, wstring_view __fmt, wformat_args __args)
{
    std::wstring __out;
    __detail::__contiguous_wappend_iterator __iter(__out);
