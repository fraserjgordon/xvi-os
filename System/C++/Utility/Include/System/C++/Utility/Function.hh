...
inline constexpr size_t __function_obj_size = 16;
...
public:
    ...
    {
        return _INVOKE_R<_R>(*reinterpret_cast<_T*>(__ptr(__s)), __XVI_STD_NS::forward<_Args>(__args)...);
    }
};
...
public:
    ...
    template <class _F,
              class = enable_if_t<is_invocable_v<_F, _ArgTypes...>, void>>
    function(_F __f)
        : function()
    {
    ...
    template <class _F,
              class = enable_if_t<is_invocable_v<decay_t<_F>, _ArgTypes...>, void>>
...
template <class _R, class... _ArgTypes>
bool operator==(nullptr_t, const function<_R(_ArgTypes...)>& __f) noexcept
{
    return !__f;
}
