#pragma once
#ifndef __SYSTEM_CXX_UTILITY_ALGORITHM_H
#define __SYSTEM_CXX_UTILITY_ALGORITHM_H
...
//! @TODO: change __XVI_STD_NS::foo references to __XVI_STD_UTILITY_NS::foo.
...
{
    return __XVI_STD_NS::equal(__first1, __last1, __first2, equal_to{});
}
...
{
    return __XVI_STD_NS::equal(__first1, __last1, __first2, __last2, equal_to{});
}
...
constexpr _ForwardIterator1 find_end(_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator2 __last2, _BinaryPredicate __pred)
{
    ...
    for (; __first1 != __last1; ++__first1)
    {
        auto [__i, __j] = __XVI_STD_NS::mismatch(__first1, __last1, __first2, __last2, __pred);
        if (__j == __last2)
            __result = __first1;
        if (__i == __last1)
            break;
...
{
    return __XVI_STD_NS::find_end(__first1, __last1, __first2, __last2, equal_to{});
}
...
constexpr bool is_permutation(_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator2 __last2, _BinaryPredicate __pred)
{
    ...
    auto [__start1, __start2] = __XVI_STD_NS::mismatch(__first1, __last1, __first2, __last2, __pred);
    if (__start1 == __last1 && __start2 == __last2)
        return true;

    size_t __n1 = 0;
    auto __n2 = __XVI_STD_NS::distance(__start2, __last2);

    for (; __start1 != __last1; ++__start1, (void)++__n1)
    {
        auto __where = __XVI_STD_NS::find_if(__start2, __last2, [__pred, __start1](auto&& __x) { return __pred(*__start1, __x); });
        if (__where == __last2)
            return false;
    }
...
{
    return __XVI_STD_NS::is_permutation(__first1, __last1, __first2, __last2, equal_to{});
}
...
{
    return __XVI_STD_NS::is_permutation(__first1, __last1, __first2, __XVI_STD_NS::next(__first2, __XVI_STD_NS::distance(__first1, __first2)), __pred);
}

template <class _ForwardIterator1, class _ForwardIterator2>
constexpr bool is_permutation(_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2)
{
    return __XVI_STD_NS::is_permutation(__first1, __last1, __first2, equal_to{});
}
...
constexpr _ForwardIterator1 search(_ForwardIterator1 __first1, _ForwardIterator1 __last1, _ForwardIterator2 __first2, _ForwardIterator2 __last2, _BinaryPredicate __pred)
{
    ...
    for (; __first1 != __last1; ++__first1)
    {
        if (auto [__miss1, __miss2] = __XVI_STD_NS::mismatch(__first1, __last1, __first2, __last2, __pred); __miss2 == __last2)
            return __first1;
    }
...
{
    return __XVI_STD_NS::search(__first1, __last1, __first2, __last2, equal_to{});
}
...
{
    return __XVI_STD_NS::search_n(__first, __last, __n, __x, equal_to{});
}
...
constexpr _OutputIterator unique_copy(_InputIterator __first, _InputIterator __last, _OutputIterator __result, _BinaryPredicate __pred)
{
    ...
    {
        *__result = *__first;
        _OutputIterator __cmp = __result;
        ++__result;
        ++__first;

        for (; __first != __last; ++__first)
        {
            if (__pred(*__first, *__cmp) != false)
                continue;
...
{
    return __XVI_STD_NS::unique_copy(__first, __last, __result, equal_to{});
}
...
constexpr _ForwardIterator rotate(_ForwardIterator __first, _ForwardIterator __middle, _ForwardIterator __last)
{
    ...
    __XVI_STD_NS::rotate(__write, __victim_ptr, __read);
...
{
    return __XVI_STD_NS::is_sorted_until(__first, __last, less{});
}

template <class _ForwardIterator, class _Compare>
constexpr bool is_sorted(_ForwardIterator __first, _ForwardIterator __last, _Compare __comp)
{
    return __XVI_STD_NS::is_sorted_until(__first, __last, __comp) == __last;
}

template <class _ForwardIterator>
constexpr bool is_sorted(_ForwardIterator __first, _ForwardIterator __last)
{
    return __XVI_STD_NS::is_sorted(__first, __last, less{});
}
...
{
    return __XVI_STD_NS::lower_bound(__first, __last, __value, less{});
}
...
{
    return __XVI_STD_NS::upper_bound(__first, __last, __value, less{});
}
...
{
    return {__XVI_STD_NS::lower_bound(__first, __last, __value, __comp), __XVI_STD_NS::upper_bound(__first, __last, __value, __comp)};
}
...
{
    return __XVI_STD_NS::equal_range(__first, __last, __value, less{});
}
...
{
    return __XVI_STD_NS::binary_search(__first, __last, __value, less{});
}
...
constexpr _BidirectionalIterator __stable_partition(_BidirectionalIterator __first, _BidirectionalIterator __last, _Size __n, _Predicate& __pred, pair<void*, size_t> __buffer)
{
    ...
    _BidirectionalIterator __bound1 = __XVI_STD_NS::__stable_partition(__first, __middle, __half, __pred, __buffer);
    _BidirectionalIterator __bound2 = __XVI_STD_NS::__stable_partition(__middle, __last, __n - __half, __pred, __buffer);
    ...
    //
    return __XVI_STD_NS::rotate(__bound1, __middle, __bound2);
}
...
constexpr _BidirectionalIterator stable_partition(_BidirectionalIterator __first, _BidirectionalIterator __last, _Predicate __pred)
{
    ...
    return __XVI_STD_NS::__stable_partition(__first, __last, __n, __pred, __buffer);
}
...
constexpr void inplace_merge(_BidirectionalIterator __first, _BidirectionalIterator __middle, _BidirectionalIterator __last, _Compare __comp)
{
    ...
    __XVI_STD_NS::__inplace_merge(__first, __middle, __last, __n1, __n2, __comp, __buffer);
}
...
{
    __XVI_STD_NS::inplace_merge(__first, __middle, __last, less{});
}
...
{
    return __XVI_STD_NS::set_union(__first1, __last1, __first2, __last2, __result, less{});
}
...
{
    return __XVI_STD_NS::set_intersection(__first1, __last1, __first2, __last2, __result, less{});
}
...
{
    return __XVI_STD_NS::set_difference(__first1, __last1, __first2, __last2, __result, less{});
}
...
{
    return __XVI_STD_NS::set_symmetric_difference(__first1, __last1, __first2, __last2, __result, less{});
}


constexpr size_t __heap_left(__size_t __i)
{
    return 2*__i + 1;
}

constexpr size_t __heap_right(size_t __i)
{
    return 2*__i + 2;
}

constexpr size_t __heap_parent(size_t __i)
{
    return (__i - 1) / 2;
}

template <class _RandomAccessIterator, class _Compare>
constexpr bool __heapify(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __index, _Compare __comp)
{
    size_t __length = static_cast<size_t>(__last - __first);
    
    size_t __left = __heap_left(__index);
    size_t __right = __heap_right(__index);
    size_t __largest = __index;
    ...
    if (__largest != __index)
    {
        ...
        __XVI_STD_NS::__heapify(__first, __last, __largest, __comp);
        return true;
    }
...
template <class _RandomAccessIterator, class _Compare>
constexpr size_t __bad_heap_index(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __index, _Compare __comp)
{
    size_t __length = static_cast<size_t>(__last - __first);
    ...
    if (__left < __length)
        if (size_t __bad = __bad_heap_index(__first, __last, __left, __comp); __bad != 0)
            return __bad;

    if (__right < __length)
        if (size_t __bad = __bad_heap_index(__first, __last, __right, __comp); __bad != 0)
            return __bad;
...
{
    size_t __i = static_cast<size_t>(__last - __first) - 1;
    if (__i == 0)
        return;
    
    size_t __parent = __XVI_STD_NS::__heap_parent(__i);
    while (true)
    {
        bool __continue = __XVI_STD_NS::__heapify(__first, __last, __parent, __comp);

        if (!__continue || __parent == 0)
            break;

        __parent = __XVI_STD_NS::__heap_parent(__parent);
    }
}
...
{
    __XVI_STD_NS::push_heap(__first, __last, less{});
}
...
constexpr void pop_heap(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp)
{
    ...
    __XVI_STD_NS::__heapify(__first, __last - 1, 0, __comp);
}

template <class _RandomAccessIterator>
constexpr void pop_heap(_RandomAccessIterator __first, _RandomAccessIterator __last)
{
    __XVI_STD_NS::pop_heap(__first, __last, less{});
}
...
constexpr void make_heap(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp)
{
    ...
    for (size_t __i = 0; __i < __len; ++__i)
        __XVI_STD_NS::__heapify(__first, __last, __len - __i - 1, __comp);
}

template <class _RandomAccessIterator>
constexpr void make_heap(_RandomAccessIterator __first, _RandomAccessIterator __last)
{
    __XVI_STD_NS::make_heap(__first, __last, less{});
}
...
{
    return __XVI_STD_NS::min(__a, __b, less{});
}
...
template <class _T>
constexpr _T min(__XVI_STD_NS::initializer_list<_T> __il)
{
    return __XVI_STD_NS::min(__il, less{});
}
...
{
    return __XVI_STD_NS::max(__a, __b, less{});
}

template <class _T, class _Compare>
constexpr _T max(__XVI_STD_NS::initializer_list<_T> __il, _Compare __comp)
{
...
template <class _T>
constexpr _T max(__XVI_STD_NS::initializer_list<_T> __il)
{
    return __XVI_STD_NS::max(__il, less{});
}
...
{
    return __XVI_STD_NS::minmax(__a, __b, less{});
}

template <class _T, class _Compare>
constexpr pair<_T, _T> minmax(__XVI_STD_NS::initializer_list<_T> __il, _Compare __comp)
{
    const _T& __min = *__il.begin();
    const _T& __max = *__il.begin();
...
template <class _T>
constexpr pair<_T, _T> minmax(__XVI_STD_NS::initializer_list<_T> __il)
{
    return __XVI_STD_NS::minmax(__il, less{});
}
...
{
    return __XVI_STD_NS::min_element(__first, __last, less{});
}
...
{
    return __XVI_STD_NS::max_element(__first, __last, less{});
}
...
{
    return __XVI_STD_NS::minmax_element(__first, __last, less{});
}
...
{
    return __XVI_STD_NS::clamp(__value, __lo, __hi, less{});
}
...
constexpr void __introsort(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp, size_t __depth)
{
    ...
    if (__n <= _InsertionSortThreshold)
    {
        ...
        __XVI_STD_NS::__insertion_sort(__first, __last, __comp);
        return;
    }
    ...
    if (__depth == 0)
    {
        ...
        __XVI_STD_NS::make_heap(__first, __last, __comp);
        __XVI_STD_NS::sort_heap(__first, __last, __comp);
        return;
    }
    ...
    _RandomAccessIterator __pivot = __XVI_STD_NS::__median_of_three(__first, __last, __comp);
    _RandomAccessIterator __pivot_stash = __last - 1;
    __XVI_STD_NS::iter_swap(__pivot, __pivot_stash);
    __pivot = __XVI_STD_NS::partition(__first, __pivot_stash, [&__comp, __pivot_stash](const auto& __x) -> bool
        {
    ...
    __XVI_STD_NS::__introsort(__first, __pivot, __comp, __depth - 1);
    __XVI_STD_NS::__introsort(__pivot + 1, __last, __comp, __depth - 1);
}
...
constexpr void __introsort(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp)
{
    ...
    size_t __n = static_cast<size_t>(__last - __first);
    size_t __max_depth = 2 * __XVI_STD_NS::log2p1(__n);
    __XVI_STD_NS::__introsort(__first, __last, __comp, __max_depth);
}

template <class _RandomAccessIterator, class _Compare>
constexpr _RandomAccessIterator __heapselect(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __k, _Compare __comp)
{
    // Create a heap and then extract the first k elements.
    __XVI_STD_NS::make_heap(__first, __last, __comp);
    for (size_t __i = 0; __i < __k; ++__i)
        __XVI_STD_NS::pop_heap(__first, __last - __i);
...
template <class _RandomAccessIterator, class _Compare>
constexpr void __partial_introsort(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __k, _Compare __comp, size_t __depth)
{
    ...
    if (__depth == 0)
    {
        ...
        __XVI_STD_NS::__heapselect(__first, __last, __k, __comp);
        return;
    }
    ...
    size_t __pivot_pos = static_cast<size_t>(__pivot - __first);

    // The left-hand sub-array always needs to be sorted.
    __XVI_STD_NS::__partial_introsort(__first, __pivot, __k, __comp, __depth - 1);

    // The right-hand sub-array only needs to be sorted if the k'th value lies within it.
    if (__pivot_pos < __k)
        __XVI_STD_NS::__partial_introsort(__pivot + 1, __last, __k - __pivot_pos, __comp, __depth - 1);
}

template <class _RandomAccessIterator, class _Compare>
constexpr void __partial_introsort(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __k, _Compare __comp)
{
    // Arbitrary depth threshold.
    size_t __n = static_cast<size_t>(__last - __first);
    size_t __max_depth = 2 * __XVI_STD_NS::log2p1(__n);
    __XVI_STD_NS::__partial_introsort(__first, __last, __k, __comp, __max_depth);
}

template <class _RandomAccessIterator, class _Compare>
constexpr _RandomAccessIterator __introselect(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __k, _Compare __comp, size_t __depth)
{
    constexpr size_t _InsertionSortThreshold = 16;
    ...
    if (__depth == 0)
    {
        ...
        return __XVI_STD_NS::__heapselect(__first, __last, __k, __comp);
    }
    ...
    size_t __pivot_pos = static_cast<size_t>(__pivot - __first);
    if (__k < __pivot_pos)
        return __XVI_STD_NS::__introselect(__first, __pivot, __k, __comp, __depth - 1);
    else if (__k > __pivot_pos)
        return __XVI_STD_NS::__introselect(__pivot + 1, __last, __k - __pivot_pos, __comp, __depth - 1);
    else
        return __pivot;
}

template <class _RandomAccessIterator, class _Compare>
constexpr void __introselect(_RandomAccessIterator __first, _RandomAccessIterator __last, size_t __k, _Compare __comp)
{
    // Arbitrary depth threshold.
    size_t __n = static_cast<size_t>(__last - __first);
    size_t __max_depth = 2 * __XVI_STD_NS::log2p1(__n);
    __XVI_STD_NS::__introselect(__first, __last, __k, __comp, __max_depth);
}

template <class _RandomAccessIterator, class _Compare>
constexpr void sort(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp)
{
    __XVI_STD_NS::__introsort(__first, __last, __comp);
}

template <class _RandomAccessIterator>
constexpr void sort(_RandomAccessIterator __first, _RandomAccessIterator __last)
{
    __XVI_STD_NS::sort(__first, __last, less{});
}
...
{
    size_t __k = static_cast<size_t>(__nth - __first);
    __XVI_STD_NS::__introselect(__first, __last, __k, __comp);
}

template <class _RandomAccessIterator>
constexpr void nth_element(_RandomAccessIterator __first, _RandomAccessIterator __nth, _RandomAccessIterator __last)
{
    __XVI_STD_NS::nth_element(__first, __nth, __last, less{});
}
...
{
    size_t __k = static_cast<size_t>(__middle - __first);
    __XVI_STD_NS::__partial_introsort(__first, __last, __k, __comp);
}

template <class _RandomAccessIterator>
constexpr void partial_sort(_RandomAccessIterator __first, _RandomAccessIterator __middle, _RandomAccessIterator __last)
{
    __XVI_STD_NS::partial_sort(__first, __middle, __last, less{});
}
...
constexpr bool next_permutation(_BidirectionalIterator __first, _BidirectionalIterator __last, _Compare __comp)
{
    ...
    __XVI_STD_NS::reverse(__XVI_STD_NS::next(__k), __last);
    return true;
}
