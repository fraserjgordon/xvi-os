...
auto not_fn(_F&& __f)
{
    return [__f = __XVI_STD_NS::forward<_F>(__f)]<class... _CallArgs>(_CallArgs&&... __call_args) mutable
    {
        return !invoke(__XVI_STD_NS::forward<_F>(__f), __XVI_STD_NS::forward<_CallArgs>(__call_args)...);
    };
}
...
auto mem_fn(_R _T::* __pm) noexcept
{
    ...
    {
        return __detail::_INVOKE(__pm, __t, __XVI_STD_NS::forward<_CallArgs>(__call_args)...);
    };
}
...
{
    return [__f = __XVI_STD_NS::forward<_F>(__f), ...__bound_args = unwrap_ref_decay_t<_Args>(__args)]<class... _CallArgs>(_CallArgs&&... __call_args) mutable
    {
        return invoke(__XVI_STD_NS::forward<_F>(__f), __XVI_STD_NS::forward<unwrap_ref_decay_t<_Args>>(__bound_args)..., __XVI_STD_NS::forward<_CallArgs>(__call_args)...);
    };
}
...
{
    if constexpr (_I == 1)
        return __XVI_STD_NS::forward<_FirstArg>(__f);
    else
        return __ith_call_arg<_I - 1>(__XVI_STD_NS::forward<_CallArgs...>(__args)...);
}

template <class _F, class... _BoundArgs>
struct __bind_expression_base
{
    using __fn_t    = decay_t<_F>;
    using __tuple_t = tuple<decay_t<_BoundArgs>...>;
    ...
    static _V<_FD, _I, _CallArgs...> __v(_Bound&& __bound_args, _CallArgs&&... __call_args)
    {
        ...
        if constexpr (__detail::__is_reference_wrapper_specialization<_TDi>::value)
            ...
            return __tdi(__XVI_STD_NS::forward<_CallArgs>(__call_args)...);
        else if constexpr (is_placeholder_v<_TDi>)
            return __ith_call_arg<is_placeholder_v<_TDi>>(__XVI_STD_NS::forward<_CallArgs>(__call_args)...);
        else
            return __tdi;
    }
    ...
    {
        using __ret_t = tuple<decltype(__v<_Idx, _FD>(__bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...))...>;
        return __ret_t(__v<_Idx, _FD>(__bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...)...);
    }
    ...
    {
        return __make_arg_tuple_helper<_FD>(make_integer_sequence<int, tuple_size_v<__tuple_t>>(), __bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...);
    }
};
...
struct __bind_expression : __bind_expression_base<_F, _BoundArgs...>
{
    ...
    {
        return apply(__base::_M_fn, __base::__make_arg_tuple(__base::_M_fn, __base::_M_bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...));
    }
    ...
    template <class... _CallArgs>
    decltype(auto) operator()(_CallArgs&&... __call_args) volatile
    {
        return apply(__base::_M_fn, __base::__make_arg_tuple(__base::_M_fn, __base::_M_bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...));
    }

    template <class... _CallArgs>
    decltype(auto) operator()(_CallArgs&&... __call_args) const volatile
    {
        return apply(__base::_M_fn, __base::__make_arg_tuple(__base::_M_fn, __base::_M_bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...));
    }
};
...
struct __bind_r_expression : __bind_expression_base<_F, _BoundArgs...>
{
    ...
    decltype(auto) operator()(_CallArgs&&... __call_args)
    {
        return __apply_r<_R>(__base::_M_fn, __base::__make_arg_tuple(__base::_M_fn, __base::_M_bound_args, __XVI_STD_NS::forward<_CallArgs>(__call_args)...));
    }
...
{
    return __detail::__bind_expression<_F, _BoundArgs...>{__XVI_STD_NS::forward<_F>(__f), {__XVI_STD_NS::forward<_BoundArgs>(__bound_args)...}};
}

template <class _R, class _F, class... _BoundArgs>
auto bind(_F&& __f, _BoundArgs&&... __bound_args)
{
    return __detail::__bind_r_expression<_R, _F, _BoundArgs...>{__XVI_STD_NS::forward<_F>(__f), {__XVI_STD_NS::forward<_BoundArgs>(__bound_args)...}};
}
