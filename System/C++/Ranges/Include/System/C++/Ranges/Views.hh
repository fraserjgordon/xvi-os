#ifndef __SYSTEM_CXX_RANGES_VIEWS_H
#define __SYSTEM_CXX_RANGES_VIEWS_H
...
private:
    ...
    public:
        ...
        {
            if constexpr (__XVI_STD_CORE_NS::__detail::__is_integer_like<_W> 
                          && !__XVI_STD_CORE_NS::__detail::__is_signed_integer_like<_W>)
            {
            ...
            requires __detail::__advanceable<_W>
        {
            ...
            if constexpr (__XVI_STD_CORE_NS::__detail::__is_integer_like<_W>)
            {
                if constexpr (__XVI_STD_CORE_NS::__detail::__is_signed_integer_like<_W>)
...
public:
            ...
            || sized_sentinel_for<_Bound, _W>
    {
        ...
        if constexpr (__XVI_STD_CORE_NS::__detail::__is_integer_like<_W>
                      && __XVI_STD_CORE_NS::__detail::__is_integer_like<_Bound>)
        {
...
template <class _W, class _Bound>
    requires (!__XVI_STD_CORE_NS::__detail::__is_integer_like<_W>
              || !__XVI_STD_CORE_NS::__detail::__is_integer_like<_Bound>
              || (__XVI_STD_CORE_NS::__detail::__is_signed_integer_like<_W> == __XVI_STD_NS::__detail::__is_signed_integer_like<_Bound>))
...
template <input_range _V, __XVI_STD_NS::copy_constructible _F>
    requires view<_V>
        ...
        && __XVI_STD_CORE_NS::__detail::__can_reference<__XVI_STD_NS::invoke_result_t<_F, range_reference_t<_V>>>
...
template <copy_constructible _F, input_range... _Views>
    requires (view<_Views> && ...)
        ...
        && __XVI_STD_CORE_NS::__detail::__can_reference<__XVI_STD_NS::invoke_result_t<_F&, range_reference_t<_Views>...>>
...
#endif /* ifndef __SYSTEM_CXX_RANGES_VIEWS_H */
