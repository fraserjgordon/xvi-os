#ifndef __SYSTEM_CXX_STRING_CHARTRAITS_H
#define __SYSTEM_CXX_STRING_CHARTRAITS_H
...
constexpr int __char_traits_compare(const _T* __s1, const _T* __s2, size_t __n)
{
    ...
    {
        int __diff = static_cast<int>(__s1[__i]) - static_cast<int>(__s2[__i]);
        if (__diff != 0)
            return __diff;
    }
...
template <> struct char_traits<char>
{
    ...
    static constexpr int compare(const char_type* __s1, const char_type* __s2, size_t __n)
    {
        for (size_t __i = 0; __i < __n; ++__i)
        {
            int __diff = static_cast<int>(static_cast<unsigned char>(__s1[__i])) - static_cast<int>(static_cast<unsigned char>(__s2[__i]));
            if (__diff != 0)
                return __diff;
        }
...
#endif /* ifndef __SYSTEM_CXX_STRING_CHARTRAITS_H */
