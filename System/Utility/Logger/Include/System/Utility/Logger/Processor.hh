...
__SYSTEM_UTILITY_LOGGER_EXPORT opaque_processor registerEncodedProcessor(message_processor_callback, void*) __SYSTEM_UTILITY_LOGGER_SYMBOL(RegisterEncodedProcessor);
